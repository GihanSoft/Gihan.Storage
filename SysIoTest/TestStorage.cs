...
namespace SysIoTest
{
    public class TestStorage
    {
        ...
        public void TestCopy()
        {
            ...
            tempFile.Copy(@"E:\", tempFile.Name, NameCollisionOption.FailIfExists);
        ...
        public void TestCopyExistConflict()
        {
            ...
            Assert.AreEqual(pastedFile.Path, pastedFile2.Path);
        ...
        public void TestMoveExistConflict()
        {
            ...
            Assert.AreNotEqual(tempFile.Path, pastedFile.Path);
            Assert.AreEqual(pastedFile.Parent.Path, tempFile.Parent.Path);
            pastedFile.Delete();
            tempFile.Delete();
            //////////////////
            //SysIO.File.Delete(tempPath);
