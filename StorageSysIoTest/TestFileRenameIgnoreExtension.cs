...
{
    public class TestFileRenameIgnoreExtension
    {
        [Fact]
        public void TestNormalRename_FailIfExists()
        {
            ...
            var tempFileExtension = GetExtension(tempFilePath);
            ...
            do
            {
                ...
                newPath = Combine(tempPathParent, newName + tempFileExtension);
            } while (IO.File.Exists(newPath));

            var file = new File(tempFilePath);

            file.RenameIgnoreExtension(newName);
        ...
        public void TestNormalRename_GenerateUniqueName()
        {
            ...
            file.RenameIgnoreExtension(newName, NameCollisionOption.GenerateUniqueName);
        ...
        public void TestNormalRename_ReplaceExisting()
        {
            ...
            file.RenameIgnoreExtension(newName, NameCollisionOption.ReplaceExisting);
        ...
        //===================================================== //todo set below for ignore extension
